...
Store _$StoreFromJson(Map<dynamic, dynamic> json) {
  //print(json);
  //var socialList = json['social'] as List;
  //var addressList = json['address'] as List;
  //var ratingList = json['rating'] as List;
  return Store()
    ..id = json['id'] as int
    ..storeName = json['store_name'] as String
    ..firstName = json['first_name'] as String
    ..lastName = json['last_name'] as String
    //..social = socialList.isEmpty ? null : Social.fromJson(json['social'])
    ..phone = json['phone'] as String
    ..showEmail = json['show_email'] as bool
    //..address = addressList.isEmpty ? null : Address.fromJson(json['address'])
    ...
    //..rating = ratingList.isEmpty ? null : Rating.fromJson(json['rating'])
...
Social _$SocialFromJson(Map<Map<dynamic, dynamic>, dynamic> json) {
  return Social()
...
Address _$AddressFromJson(Map<Map<dynamic, dynamic>, dynamic> json) {
  return Address()
...
Rating _$RatingFromJson(Map<Map<dynamic, dynamic>, dynamic> json) {
  return Rating()
